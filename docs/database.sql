CREATE DATABASE pd_hector_vargas_manglar


DROP TABLE IF EXISTS platform, statu, invoices, transactions, clients CASCADE
...
CREATE TABLE transactions(
		id_transaction VARCHAR(250) PRIMARY KEY,
